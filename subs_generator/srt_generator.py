...
def setup_rtx4000_model():
    ...
    # Debug détaillé pour comprendre pourquoi CUDA n'est pas détecté
    ...
    if not torch.cuda.is_available():
        ...
        print("   💡 Vérifiez que PyTorch avec CUDA est installé dans le même environnement")
        print("   💡 Commande: pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu121")
